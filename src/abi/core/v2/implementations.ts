...
export const implementations: AbiItem[] = [
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'bytes4[]', name: 'sigs', type: 'bytes4[]' },
    ],
  ...
  },
  {
    inputs: [],
    name: 'instaIndex',
    outputs: [{ internalType: 'contract IndexInterface', name: '', type: 'address' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  {
    inputs: [{ internalType: 'address', name: '_defaultImplementation', type: 'address' }],
